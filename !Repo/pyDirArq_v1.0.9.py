"""
ARQUIVO GERADO — pyDirArq_v1.0.9.py
Integração: wrapperPandas + salvamento dos dados do os.walk em tabPyDirArq_001.xlsx
"""
...
#===================================================================================================
# Classe EstouVivo (mantida inalterada)
#===================================================================================================
class EstouVivo:
...
def main(pathDir_, pathDirRels_):
    ...
    printStyled(f"\n✅ Dados salvos em 'tabPyDirArq_001.xlsx' (tabela a partir de B2)", fg='GREEN')
...
#===================================================================================================
# Fim do arquivo pyDirArq_v1.0.9.py
#===================================================================================================
