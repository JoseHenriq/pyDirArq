#===================================================================================================
# Programa : pyDirArq_v1.1.2.py
# Descrição: salva arquivos e subdiretórios de um diretorio totalizando o tamanho dos arquivos e
# subdiretórios.
#---------------------------------------------------------------------------------------------------
# Data : 29/06/2026 dom
#---------------------------------------------------------------------------------------------------
# Utilização: python pyDirArq_v1.1.2.py
# --------------------------------------------------------------------------------------------------
# Versão 1.1.2 - criação de nova planilha;
...
nomeArquivoExcel = 'tabPyDirArq_005.xlsx'
numSheet         = 1
nomePlanilha     = f'Sheet{numSheet}'
...
class wrapperPandas:
    ...
    #--- Cria nova planilha
    def criar_nova_sheet(self, workbook, nome_nova_sheet=None, df=None):
        """
...
#===================================================================================================
# Fim do arquivo pyDirArq_v1.1.2.py
#===================================================================================================
